<?php include('header.php'); ?>  
	...
	<p>Tragen Sie bitte Ihr Problem in das Formular ein oder schauen Sie nach dem Bearbeitungsstatus ihres Problems.<br>Selbstverst�ndlich k�nnen Sie uns auch ein Feedback zu unserem Helpdesk oder anderem geben.</p>
        
	<form id="kontakt" method="post" action="?action=eintragen">
    		<div class="hinweis">
			<h2>Allgemeine Information</h2>
    			<p>S�mtliche Felder in dem Formular m�ssen ausgef�llt sein.<br>    		
    			<br>Die Probleme sollten detailliert wie m�glich dargestellt werden und die Dringlichkeit wollte ehrlich beantwortet werden, um einen reibungslosen Ablauf zu gew�hrleisten.<br>
			<br>Sobald der Bearbeitungsstatus ihres Problems ge�ndert wurde, erhalten Sie automatisch eine E-Mail an die von Ihnen angegebene Adresse.</p>
		</div>
        	<fieldset>
            		...
            		<div class="inputgroup">
              			...
              			<textarea id="problembeschreibung" placeholder="Bitte beschreiben Sie hier ihr Problem genauer. Gerne k�nnen Sie auch beim Dateiupload ein Bild beif�gen" required value="" class="inputfield" />
				</textarea>
            		</div>	
            		<div class="inputgroup">
